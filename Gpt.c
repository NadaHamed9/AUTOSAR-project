...
/* lo kan gpt configrubale kan hyzhar file fyh Gpt_Cfg.h w ha3mel Gpt_PBcfg.c w
 * sa3tha el address bta3 function hyb2a member fy struct bakhtaro
 * msh hyb2a global var ba7oto manually*/
